...
<img src="../../<?= str_replace("\\","/", $m["hinhanh"])?>.jpg" width="400" class="img-thumbnail"></a>
...
<p><a class="btn btn-warning" href="index.php?action=sua&id=<?php echo $m["id"]; ?>"><i class="align-middle"
            data-feather="edit"></i> Sửa</a>
    <a class="btn btn-danger" href="index.php?action=xoa&id=<?php echo $m["id"]; ?>"><i class="align-middle"
            data-feather="trash-2"></i> Xóa</a>
</p>
