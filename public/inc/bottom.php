            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-light">
                        ...
                        <h4> 
                            <span class="badge text-white bg-danger">Alogic </span>
                            <span class="badge text-white bg-warning">Company</span> - Công ty dược phẩm hàng đầu Việt Nam</h4></a>
                        <p><b><i>Địa chỉ:</i></b> 18 Ung Văn Khiêm, phường Đông Xuyên, TP Long Xuyên, An Giang<br>
                            <b><i>Điện thoại:</i></b> 076 3841190<br> 
                            <b><i>Email:</i></b> Alogic Company@gmail.com<br> 
                            <b><i>Zalo:</i></b> 0918888902</p>
                    </div>
                ...
                <hr>
                <p class="m-0 text-center text-warning fw-bolder">Copyright &copy; Alogic Company</p></div>
        </footer>
