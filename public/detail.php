        ...
        <div>
            <h4 class="text-primary">Giá bán:
                <span class="text-danger">
                    <?php echo number_format($mhct["giagoc"]); ?> đ
                </span>
            </h4>
                        ...
                        <div class="col mb-5">
                            <div class="card h-100 shadow">
                                ...
                                <a href="?action=detail&id=<?php echo $m["id"]; ?>">
                                    <img class="card-img-top" src="../<?php echo str_replace('\\', '/', $m["hinhanh"]); ?>.jpg"
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <!-- Product name-->
                                        <a class="text-decoration-none" href="?action=detail&id=<?php echo $m["id"]; ?>">
